        ...
        <div className="flex flex-col flex-1 gap-4">
          ...
          <p className="text-red-700 text-sm">{imageUploadError && imageUploadError}</p>
          {
            formData.imageUrls.length > 0 && formData.imageUrls.map((url, index) => (
              <div key={index} className="flex justify-between p-3 items-center border">
          ...
          <button className="p-3 bg-slate-700 text-white rounded uppercase hover:opacity-95 disabled:opacity-80">
            Create Listing
          </button>
        </div>
      </form>
